...
describe('HeroComponent (Shallow test)', () => {
    ...
    beforeEach(() => {
        ...
        TestBed.configureTestingModule({
            ...
            schemas: [NO_ERRORS_SCHEMA] // Tells angular that for this module do not errr if you encounter an unknown attribute or an unknown elment in the HTML of the template
                                        // on ly use when absolutely necessary, it hides errors we might need
        });
